...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //bug en el 4, fixear que se actualize bien el stock en el map
        ...
        while (true){
            ...
            if (input == 0){
                ...
                String nombre = nombreProducto.nextLine();
                int cantidad = cantidadProducto.nextInt();
                deposito.descontarStockProducto(productos, nombre, cantidad);
            }
            else if (input == 3){
                deposito.printStock();
            }
            else if (input == 4){
                deposito.printValorStock(productos);
                System.out.println(productos);
                System.out.println(deposito.getStock());
            }
            else if (input == 5){
                deposito.printProductosSinStock(productos);
            }
            else if (input == 6){
                System.out.println("\n Ingrese el nombre del producto que quiere revisar");
                String nombre = nombreProducto.nextLine();
                deposito.printStockProducto(deposito.getStock(), nombre);
            }
        }
    }
}
